...
#define DAP_DP_SUPPOTS_SWD			BIT(0)
#define DAP_DP_SUPPOTS_JTAG			BIT(1)
#define DAP_SWO_SUPPOTS_UART			BIT(2)
#define DAP_SWO_SUPPOTS_MANCHESTER		BIT(3)
#define DAP_SUPPORTS_ATOMIC_COMMANDS		BIT(4)
#define DAP_SUPPORTS_TIMESTAMP_CLOCK		BIT(5)
#define DAP_SWO_SUPPOTS_STREAM			BIT(6)
...
int jtag_teardown(const struct device *const dev);
