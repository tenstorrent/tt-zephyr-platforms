...
#define TT_BH_PINMUX_B15_UART0_RX (49) (PINCTRL_TT_BH_AF1) \
	(PINCTRL_TT_BH_TRIEN | PINCTRL_TT_BH_RXEN)

/* I2C0-I2C2 are assigned GPIO number -1 because they do not have an associated GPIO number */
#define TT_BH_PINMUX_C33_I2C0_SCL (0xfffffffe) (PINCTRL_TT_BH_AF0) (PINCTRL_TT_BH_PUEN)
#define TT_BH_PINMUX_D32_I2C0_SDA (0xfffffffd) (PINCTRL_TT_BH_AF0) \
	(PINCTRL_TT_BH_PUEN | PINCTRL_TT_BH_RXEN)

#define TT_BH_PINMUX_D27_I2C1_SCL (0xfffffffc) (PINCTRL_TT_BH_AF0) (PINCTRL_TT_BH_PUEN)
#define TT_BH_PINMUX_D25_I2C1_SDA (0xfffffffb) (PINCTRL_TT_BH_AF0) \
	(PINCTRL_TT_BH_PUEN | PINCTRL_TT_BH_RXEN)

#define TT_BH_PINMUX_B34_I2C2_SCL (0xfffffffa) (PINCTRL_TT_BH_AF0) (PINCTRL_TT_BH_PUEN)
#define TT_BH_PINMUX_A33_I2C2_SDA (0xfffffff9) (PINCTRL_TT_BH_AF0) \
	(PINCTRL_TT_BH_PUEN | PINCTRL_TT_BH_RXEN)
