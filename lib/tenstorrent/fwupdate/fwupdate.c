...
static const struct device *flash1_dev = DEVICE_DT_GET(FLASH1_NODE);
...
#define FLASH1_NODE       DT_NODELABEL(flash1)
...
static const struct device *const __maybe_unused flash0_dev = DEVICE_DT_GET(FLASH0_NODE);
static const struct device * __maybe_unused flash1_dev = DEVICE_DT_GET(FLASH1_NODE);
