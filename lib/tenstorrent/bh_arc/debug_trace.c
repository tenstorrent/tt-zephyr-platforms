...
void DebugTraceInit(TraceBufferMode trace_buffer_mode, uint32_t trace_buffer_addr, uint32_t trace_buffer_size) {
  ...
  WriteReg(CHIP_DEBUG_TRACE_CHIP_DEBUG_TRACE_BUFFER_DESTINATION_ADDR_REG_ADDR, trace_buffer_addr);
  WriteReg(CHIP_DEBUG_TRACE_CHIP_DEBUG_TRACE_BUFFER_DESTINATION_SIZE_REG_ADDR, trace_buffer_size);
  ...
  WriteReg(CHIP_DEBUG_TRACE_CHIP_DEBUG_TRACE_CLIENT_FILTER_CNT_REG_ADDR, client_filtering_cntl.val);
