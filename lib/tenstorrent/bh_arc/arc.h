...
static inline unsigned int ArcGetTimer0() {
...
static inline void ArcSetIsrVect(uint32_t volatile intvec, volatile uint32_t intvec_num) {  
  //# intvbase_preset --- This sets the upper 22 bits of the interrupt vector base configuration 
  // register, VECBASE_AC_BUILD.  On reset, that register is loaded into the interrupt vector base 
