...
void CalculateHarvesting(void)
{
	...
	if (tt_bh_fwtable_get_fw_table(fwtable_dev)->feature_enable.harvesting_en) {
		...
		if (disabled_tensix_cols <
			tt_bh_fwtable_get_fw_table(fwtable_dev)->product_spec_harvesting.tensix_col_disable_count) {
		...
		uint8_t desired_gddr_count =
			8 - tt_bh_fwtable_get_fw_table(fwtable_dev)->product_spec_harvesting.dram_disable_count;
	...
	tile_enable.pcie_usage[0] = tt_bh_fwtable_get_fw_table(fwtable_dev)->pci0_property_table.pcie_mode;
	if (tile_enable.pcie_usage[0] == FwTable_PciPropertyTable_PcieMode_DISABLED) {
		...
		tile_enable.pcie_num_serdes[0] =
			MIN(tt_bh_fwtable_get_fw_table(fwtable_dev)->pci0_property_table.num_serdes, 2);
	...
	tile_enable.pcie_usage[1] = tt_bh_fwtable_get_fw_table(fwtable_dev)->pci1_property_table.pcie_mode;
	if (tile_enable.pcie_usage[1] == FwTable_PciPropertyTable_PcieMode_DISABLED) {
		...
		tile_enable.pcie_num_serdes[1] =
			MIN(tt_bh_fwtable_get_fw_table(fwtable_dev)->pci1_property_table.num_serdes, 2);
