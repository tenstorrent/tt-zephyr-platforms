...
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_REG_ADDR  \
  0x00300104
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_UPPER_TARGET_ADDR_OFF_INBOUND_1_REG_ADDR \
  0x00300318
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_1_REG_ADDR  \
  0x00300304
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PORT_LINK_CTRL_OFF_REG_ADDR    0x00000710
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN2_CTRL_OFF_REG_ADDR         0x0000080C
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CAPABILITIES_REG_REG_ADDR   0x0000007C
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_DBI2_BAR0_MASK_REG_REG_ADDR     0x00100010
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_DBI2_BAR5_MASK_REG_REG_ADDR     0x00100024
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_MISC_CONTROL_1_OFF_REG_ADDR    0x000008BC
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_CLASS_CODE_REVISION_ID_REG_ADDR 0x00000008
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_ADDR        0x00000040
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_SUBSYSTEM_ID_SUBSYSTEM_VENDOR_ID_REG_REG_ADDR \
  0x0000002C
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_REG_ADDR \
  0x00000070
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_PL32G_EXT_CAP_HDR_REG_REG_ADDR 0x000001F0
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_ACK_F_ASPM_CTRL_OFF_REG_ADDR  0x0000070C
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_PTM_CAP_OFF_REG_ADDR             0x00000378
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR     0x00000890
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_EQ_CONTROL_OFF_REG_ADDR  0x000008A8
#define PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PIPE_LOOPBACK_CONTROL_OFF_REG_ADDR      \
  0x000008B8
...
} BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_REG_DEFAULT (0x00000000)
...
typedef struct {
  ...
  uint32_t rsvdp_28: 4;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_REG_DEFAULT       \
  (0x001F0120)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_REG_DEFAULT (0x300110FF)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_REG_DEFAULT      \
  (0x00477D05)
...
typedef struct {
  ...
  uint32_t rsvdp_26: 6;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_MISC_CONTROL_1_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_MISC_CONTROL_1_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_MISC_CONTROL_1_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_MISC_CONTROL_1_OFF_REG_DEFAULT       \
  (0x000BFF58)
...
} BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_HDL_PATH_F20946C1_CLASS_CODE_REVISION_ID_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_HDL_PATH_F20946C1_CLASS_CODE_REVISION_ID_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_HDL_PATH_F20946C1_CLASS_CODE_REVISION_ID_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_HDL_PATH_F20946C1_CLASS_CODE_REVISION_ID_REG_DEFAULT    \
  (0x00000000)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_DEFAULT (0xDFC35001)
...
typedef struct {
  ...
  uint32_t rsvd: 1;
  uint32_t rsvdp_31: 1;
} BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_reg_t
    f;
} BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_REG_DEFAULT \
  (0x0002B010)
...
} BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_REG_DEFAULT      \
  (0x2301001E)
...
typedef struct {
  ...
  uint32_t cap_version: 4;
  uint32_t next_offset: 12;
} BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_REG_DEFAULT     \
  (0x2201002A)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_ACK_F_ASPM_CTRL_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_ACK_F_ASPM_CTRL_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_ACK_F_ASPM_CTRL_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_ACK_F_ASPM_CTRL_OFF_REG_DEFAULT      \
  (0x9BFFFF00)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_HDL_PATH_FC87603D_PTM_CAP_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_HDL_PATH_FC87603D_PTM_CAP_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_HDL_PATH_FC87603D_PTM_CAP_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_HDL_PATH_FC87603D_PTM_CAP_OFF_REG_DEFAULT (0x0000100F)
...
typedef struct {
  ...
  uint32_t rsvdp_26: 6;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_REG_DEFAULT         \
  (0x00402001)
...
typedef struct {
  ...
  uint32_t rsvdp_31: 1;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_REG_DEFAULT      \
  (0x0D001060)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_REG_DEFAULT \
  (0x0000FFFF)
...
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_SYMBOL_TIMER_FILTER_1_OFF_reg_t;

typedef union {
  uint32_t val;
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_SYMBOL_TIMER_FILTER_1_OFF_reg_t f;
} BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_SYMBOL_TIMER_FILTER_1_OFF_reg_u;

#define BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_SYMBOL_TIMER_FILTER_1_OFF_REG_DEFAULT \
  (0x00000140)
...
static inline void WriteSerdesAlphaCoreReg(const uint8_t inst, const uint32_t addr, const uint32_t data) {
  const uint8_t noc_id = 0;
...
static inline void SetupDbiAccess() {
  ...
  // flush out NOC_TLB_DATA register so that subsequent dbi writes are mapped to the correct location
  ReadSiiReg(PCIE_NOC_TLB_DATA_REG_OFFSET(DBI_PCIE_TLB_ID));
}

static void SetupOutboundTlbs() {
  static const PCIE_SII_NOC_TLB_DATA_reg_t tlb_settings[] = {
    { .atu_bypass = 1, },
    { .atu_bypass = 1, .ro = 1, },
    { .atu_bypass = 1, .ns = 1, },
    { .atu_bypass = 1, .ro = 1, .ns = 1, },
    { },
    { .ro = 1, },
    { .ns = 1, },
    { .ro = 1, .ns = 1, },
  ...
  for (unsigned int i = 0; i < sizeof(tlb_settings)/sizeof(tlb_settings[0]); i++) {
...
static void ConfigurePCIeTlbs(uint8_t pcie_inst) {
  ...
  NOC2AXITlbSetup(ring, PCIE_SERDES0_ALPHACORE_TLB, ring0_logic_x, ring0_logic_y, CMN_A_REG_MAP_BASE_ADDR);
  NOC2AXITlbSetup(ring, PCIE_SERDES1_ALPHACORE_TLB, ring0_logic_x, ring0_logic_y, CMN_A_REG_MAP_BASE_ADDR + SERDES_INST_OFFSET);
  NOC2AXITlbSetup(ring, PCIE_SERDES0_CTRL_TLB, ring0_logic_x, ring0_logic_y, SERDES_SS_0_A_REG_MAP_BASE_ADDR + PCIE_SERDES_SOC_REG_OFFSET);
  NOC2AXITlbSetup(ring, PCIE_SERDES1_CTRL_TLB, ring0_logic_x, ring0_logic_y, SERDES_SS_0_A_REG_MAP_BASE_ADDR + SERDES_INST_OFFSET + PCIE_SERDES_SOC_REG_OFFSET);
  NOC2AXITlbSetup(ring, PCIE_SII_REG_TLB, ring0_logic_x, ring0_logic_y, PCIE_SII_A_REG_MAP_BASE_ADDR);
  NOC2AXITlbSetup(ring, PCIE_DBI_REG_TLB, ring0_logic_x, ring0_logic_y, DBI_ADDR);
  NOC2AXITlbSetup(ring, PCIE_TLB_CONFIG_TLB, ring0_logic_x, ring0_logic_y, PCIE_TLB_CONFIG_ADDR);
}

static inline PCIeInitStatus LoadSerdesFirmware(const uint8_t serdes_inst) {
  const uint8_t noc_id = 0;
  const uint8_t img_tlb = (serdes_inst == 0) ? PCIE_SERDES0_ALPHACORE_TLB : PCIE_SERDES1_ALPHACORE_TLB;
  const uint32_t *serdes_img_src = (uint32_t *) PCIE_SERDES_IMG_ADDR;
  uint32_t *serdes_img_dst = (uint32_t *) GetTlbWindowAddr(noc_id, img_tlb, PCIE_SERDES_SRAM_OFFSET);
  ...
  switchclk_dbe_cmn_reg.val = ReadSerdesAlphaCoreReg(serdes_inst, CMN_A_switchclk_dbe_cmn_REG_OFFSET);
  switchclk_dbe_cmn_reg.f.master_apb_sel_nt = 1;
  WriteSerdesAlphaCoreReg(serdes_inst, CMN_A_switchclk_dbe_cmn_REG_OFFSET, switchclk_dbe_cmn_reg.val);
...
static inline void SerdesConfigWrite(uint8_t serdes_inst) {
  uint32_t serdes_regs_count = sizeof(serdes_regs) / sizeof(serdes_regs[0]);
...
static PCIeInitStatus SerdesInit(uint8_t pcie_inst, PCIeDeviceType device_type, uint8_t num_serdes_instance) {
  ...
  if (num_serdes_instance == 2) {
    ...
    uint32_t pcie_misc_cntl_3_addr = (pcie_inst == 0) ? RESET_UNIT_PCIE_MISC_CNTL_3_REG_ADDR : RESET_UNIT_PCIE1_MISC_CNTL_3_REG_ADDR;
  ...
  uint32_t pcie_misc_cntl_2_addr = (pcie_inst == 0) ? RESET_UNIT_PCIE_MISC_CNTL_2_REG_ADDR : RESET_UNIT_PCIE1_MISC_CNTL_2_REG_ADDR; 
...
static void ProgramIatu() {
  ...
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_REG_ADDR, iatu_region_ctrl_2.val);

  // BAR4 iATU programming, map inbound BAR4 access to 0x20_00000000
  uint32_t upper_target_addr = 0x20;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_UPPER_TARGET_ADDR_OFF_INBOUND_1_REG_ADDR, upper_target_addr);
  iatu_region_ctrl_2.f.bar_num = 4;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_1_REG_ADDR, iatu_region_ctrl_2.val);
}

// reduce PCIe width to 8 lanes
static void ReducePCIeWidth() {
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_u port_link_ctrl;
  port_link_ctrl.val = BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_REG_DEFAULT;
  port_link_ctrl.f.link_capable = 0xf;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PORT_LINK_CTRL_OFF_REG_ADDR, port_link_ctrl.val);

  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_reg_u gen2_ctrl_off;
  gen2_ctrl_off.val = BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_REG_DEFAULT;
  gen2_ctrl_off.f.num_of_lanes = 0x8;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN2_CTRL_OFF_REG_ADDR, gen2_ctrl_off.val);

  BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_u link_cap;
  link_cap.val = BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_REG_DEFAULT;
...
static void CntlInit(uint8_t pcie_inst, uint8_t num_serdes_instance) {
  ...
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_DBI2_BAR5_MASK_REG_REG_ADDR, 0x7);

  // Enable write to RO registers using DBI
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_MISC_CONTROL_1_OFF_reg_u misc_control_1_off;
  misc_control_1_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_MISC_CONTROL_1_OFF_REG_ADDR);
  misc_control_1_off.f.dbi_ro_wr_en = 1;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_MISC_CONTROL_1_OFF_REG_ADDR, misc_control_1_off.val);

  BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_HDL_PATH_F20946C1_CLASS_CODE_REVISION_ID_reg_u class_code_rev_id = {0};
  class_code_rev_id.f.base_class_code = 0x12; // Processing Accelerator
  class_code_rev_id.f.revision_id = 0x0;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_CLASS_CODE_REVISION_ID_REG_ADDR, class_code_rev_id.val);

  // set Vaux auxiliary current requirements to 0
  BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_reg_u nxt_ptr_reg;
  nxt_ptr_reg.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_ADDR);
  nxt_ptr_reg.f.aux_curr = 0;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_ADDR, nxt_ptr_reg.val);

  // Extract the board_type from the board_id
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_SUBSYSTEM_ID_SUBSYSTEM_VENDOR_ID_REG_REG_ADDR, ((get_read_only_table()->board_id >> 36) & 0xFFFF) << 16 | get_read_only_table()->vendor_id );

  // Hide MSI-X capability
  BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_reg_u pcie_cap_reg;
  pcie_cap_reg.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_REG_ADDR);
  pcie_cap_reg.f.pcie_cap_next_ptr = 0;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_REG_ADDR, pcie_cap_reg.val);

  // Hide L1ss capability since CLKREQ is not connected
  BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_reg_u l1sub_cap_hdr;
  l1sub_cap_hdr.val = BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_REG_DEFAULT;
  BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_reg_u pl32g_ext_cap_hdr;
  pl32g_ext_cap_hdr.val = BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_REG_DEFAULT;
  pl32g_ext_cap_hdr.f.next_offset = l1sub_cap_hdr.f.next_offset;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_PL32G_EXT_CAP_HDR_REG_REG_ADDR, pl32g_ext_cap_hdr.val);

  // Set L1 entrance latency to max
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_ACK_F_ASPM_CTRL_OFF_reg_u aspm_ctrl_off;
  aspm_ctrl_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_ACK_F_ASPM_CTRL_OFF_REG_ADDR);
  aspm_ctrl_off.f.l1_entrance_latency = 7;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_ACK_F_ASPM_CTRL_OFF_REG_ADDR, aspm_ctrl_off.val);

  // Disable ASPMs: https://tenstorrent.atlassian.net/browse/SYS-663, https://tenstorrent.atlassian.net/browse/SYS-717
  BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_u link_cap;
  link_cap.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CAPABILITIES_REG_REG_ADDR);
  ...
  BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_HDL_PATH_FC87603D_PTM_CAP_OFF_reg_u ptm_cap_off;
  ptm_cap_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_PTM_CAP_OFF_REG_ADDR);
  ptm_cap_off.f.ptm_root_capable = 0;
  ptm_cap_off.f.ptm_res_capable = 0;
  ptm_cap_off.f.ptm_clk_gran = 0;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_PTM_CAP_OFF_REG_ADDR, ptm_cap_off.val);
  ...
  for (uint8_t pcie_gen = 3; pcie_gen <= 5; pcie_gen++){
    ...
    WriteDbiRegByte(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR + 3, rate_shadow_sel);

    if (pcie_gen > 3) {
      BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_reg_u gen3_related_off;
      gen3_related_off.val = BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_REG_DEFAULT;
      gen3_related_off.f.rate_shadow_sel = rate_shadow_sel;
      gen3_related_off.f.usp_send_8gt_eq_ts2_disable = 1; // this fixes the gen4-gen5 eq failure in compliance test TD_2_11: https://tenstorrent.atlassian.net/browse/SYS-758
      WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR, gen3_related_off.val);
    }

    BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_reg_u gen3_eq_control_off;
    gen3_eq_control_off.val = BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_REG_DEFAULT;
    gen3_eq_control_off.f.gen3_eq_pset_req_vec = 0x3E0;
    gen3_eq_control_off.f.gen3_eq_fb_mode = 0x1; // disable directional mode: https://tenstorrent.atlassian.net/browse/SYS-524
    gen3_eq_control_off.f.gen3_eq_phase23_exit_mode = 0x1; // exit to EQ phase3 after EQ phase2 timeout
    WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_EQ_CONTROL_OFF_REG_ADDR, gen3_eq_control_off.val);
  }
...
void EnterLoopback() {
  ...
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_reg_u gen3_related_off;
  gen3_related_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR);
  gen3_related_off.f.gen3_equalization_disable = 1;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR, gen3_related_off.val);

  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_reg_u pipe_loopback_control_off;
  pipe_loopback_control_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PIPE_LOOPBACK_CONTROL_OFF_REG_ADDR);
  pipe_loopback_control_off.f.pipe_loopback = 1;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PIPE_LOOPBACK_CONTROL_OFF_REG_ADDR, pipe_loopback_control_off.val);

  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_u port_link_ctrl;
  port_link_ctrl.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PORT_LINK_CTRL_OFF_REG_ADDR);
  ...
  BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_SYMBOL_TIMER_FILTER_1_OFF_reg_u symbol_timer_filter_1_off;
  symbol_timer_filter_1_off.val = ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_SYMBOL_TIMER_FILTER_1_OFF_REG_ADDR);
  symbol_timer_filter_1_off.f.mask_radm_1 = 0xffff;
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_SYMBOL_TIMER_FILTER_1_OFF_REG_ADDR, symbol_timer_filter_1_off.val);

  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_FILTER_MASK_2_OFF_REG_ADDR, 0xffffffff);
}
...
void ExitLoopback() {
  ...
  WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_FILTER_MASK_2_OFF_REG_ADDR, 0x0);
}

static void SetupInboundTlbs() {
  EnterLoopback();
  WaitMs(1);
...
static void SetupSii() {
  // For GEN4 lane margining, spec requires app_margining_ready = 1 and app_margining_software_ready = 0
