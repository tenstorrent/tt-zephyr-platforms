...
static void ForceLinkSpeed(uint8_t max_pcie_speed)
{
	if (max_pcie_speed >= 1 && max_pcie_speed <= 5) {
		...
		link_cap2.val = ReadDbiReg(
			PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CAPABILITIES2_REG_REG_ADDR);
		...
		link_cap.val = ReadDbiReg(
			PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CAPABILITIES_REG_REG_ADDR);
		...
		link_control2_link_status2.val = ReadDbiReg(
			PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CONTROL2_LINK_STATUS2_REG_REG_ADDR);
...
static void ProgramIatu(void)
{
	...
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_0_REG_ADDR,
	...
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_UPPER_TARGET_ADDR_OFF_INBOUND_1_REG_ADDR,
		upper_target_addr);
	iatu_region_ctrl_2.f.bar_num = 4;
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_ATU_CAP_IATU_REGION_CTRL_2_OFF_INBOUND_1_REG_ADDR,
		iatu_region_ctrl_2.val);
}
...
static void ReducePCIeWidth(void)
{
	BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_reg_u
		port_link_ctrl;
	port_link_ctrl.val =
		BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PORT_LINK_CTRL_OFF_REG_DEFAULT;
	port_link_ctrl.f.link_capable = 0xf;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PORT_LINK_CTRL_OFF_REG_ADDR,
		    port_link_ctrl.val);

	BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_reg_u gen2_ctrl_off;

	gen2_ctrl_off.val =
		BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN2_CTRL_OFF_REG_DEFAULT;
	gen2_ctrl_off.f.num_of_lanes = 0x8;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN2_CTRL_OFF_REG_ADDR,
		    gen2_ctrl_off.val);

	BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_reg_u link_cap;

	link_cap.val =
		BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_HDL_PATH_F20946C1_LINK_CAPABILITIES_REG_REG_DEFAULT;
	link_cap.f.pcie_cap_max_link_width = 0x8;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_LINK_CAPABILITIES_REG_REG_ADDR,
		    link_cap.val);
}
...
static void CntlInit(uint8_t pcie_inst, uint8_t num_serdes_instance, uint8_t max_pcie_speed)
{
	...
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_DBI2_BAR0_MASK_REG_REG_ADDR,
		    512 * 1024 * 1024 - 1);

	/* configure BAR4 size to 32GB */
	/* BAR5_MASK_REG has the top bits of a 64-bit BAR4 mask */
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_DBI2_BAR5_MASK_REG_REG_ADDR,
		    0x7);
	...
	misc_control_1_off.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_MISC_CONTROL_1_OFF_REG_ADDR);
	misc_control_1_off.f.dbi_ro_wr_en = 1;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_MISC_CONTROL_1_OFF_REG_ADDR,
	...
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_CLASS_CODE_REVISION_ID_REG_ADDR,
	...
	nxt_ptr_reg.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_ADDR);
	nxt_ptr_reg.f.aux_curr = 0;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PM_CAP_CAP_ID_NXT_PTR_REG_REG_ADDR,
		    nxt_ptr_reg.val);

	/* Extract the board_type from the board_id */
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_TYPE0_HDR_SUBSYSTEM_ID_SUBSYSTEM_VENDOR_ID_REG_REG_ADDR,
	...
	pcie_cap_reg.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PCIE_CAP_PCIE_CAP_ID_PCIE_NEXT_CAP_PTR_PCIE_CAP_REG_REG_ADDR);
	...
	BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_reg_u
		l1sub_cap_hdr;
	l1sub_cap_hdr.val =
		BH_PCIE_DWC_PCIE_USP_PF0_L1SUB_CAP_HDL_PATH_DDA86B41_L1SUB_CAP_HEADER_REG_REG_DEFAULT;
	BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_reg_u
		pl32g_ext_cap_hdr;
	pl32g_ext_cap_hdr.val =
		BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_HDL_PATH_84B99C76_PL32G_EXT_CAP_HDR_REG_REG_DEFAULT;
	pl32g_ext_cap_hdr.f.next_offset = l1sub_cap_hdr.f.next_offset;
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PL32G_CAP_PL32G_EXT_CAP_HDR_REG_REG_ADDR,
		pl32g_ext_cap_hdr.val);
	...
	aspm_ctrl_off.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_ACK_F_ASPM_CTRL_OFF_REG_ADDR);
	aspm_ctrl_off.f.l1_entrance_latency = 7;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_ACK_F_ASPM_CTRL_OFF_REG_ADDR,
		    aspm_ctrl_off.val);
	...
	ptm_cap_off.val =
		ReadDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_PTM_CAP_OFF_REG_ADDR);
	ptm_cap_off.f.ptm_root_capable = 0;
	ptm_cap_off.f.ptm_res_capable = 0;
	ptm_cap_off.f.ptm_clk_gran = 0;
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PTM_CAP_PTM_CAP_OFF_REG_ADDR,
		    ptm_cap_off.val);
	...
	for (uint8_t pcie_gen = 3; pcie_gen <= 5; pcie_gen++) {
		...
		if (pcie_gen > 3) {
			...
			gen3_related_off.val =
				BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_RELATED_OFF_REG_DEFAULT;
		...
		gen3_eq_control_off.val =
			BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_GEN3_EQ_CONTROL_OFF_REG_DEFAULT;
		...
		WriteDbiReg(
			PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_EQ_CONTROL_OFF_REG_ADDR,
			gen3_eq_control_off.val);
	}
...
void EnterLoopback(void)
{
	...
	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_GEN3_RELATED_OFF_REG_ADDR,
		    gen3_related_off.val);

	BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_HDL_PATH_F9FD0F72_PIPE_LOOPBACK_CONTROL_OFF_reg_u
		pipe_loopback_control_off;
	pipe_loopback_control_off.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PIPE_LOOPBACK_CONTROL_OFF_REG_ADDR);
	...
	port_link_ctrl.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_PORT_LINK_CTRL_OFF_REG_ADDR);
	...
	symbol_timer_filter_1_off.val = ReadDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_SYMBOL_TIMER_FILTER_1_OFF_REG_ADDR);
	symbol_timer_filter_1_off.f.mask_radm_1 = 0xffff;
	WriteDbiReg(
		PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_SYMBOL_TIMER_FILTER_1_OFF_REG_ADDR,
		symbol_timer_filter_1_off.val);

	WriteDbiReg(PCIE_DBI_USP_A_BH_PCIE_DWC_PCIE_USP_PF0_PORT_LOGIC_FILTER_MASK_2_OFF_REG_ADDR,
		    0xffffffff);
}
