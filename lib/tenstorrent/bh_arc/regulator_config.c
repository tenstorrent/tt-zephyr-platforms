...
static const RegulatorData p300_vcore_data[] = {
	REGULATOR_DATA(p300_vcore, b0),
	REGULATOR_DATA(p300_vcore, cb),
	REGULATOR_DATA(p300_vcore, 38),
	REGULATOR_DATA(p300_vcore, 39),
...
static const RegulatorData ubb_vcore_data[] = {
	REGULATOR_DATA(ubb_vcore, b0),
	REGULATOR_DATA(ubb_vcore, cb),
	REGULATOR_DATA(ubb_vcore, d3),
	REGULATOR_DATA(ubb_vcore, ca),
	REGULATOR_DATA(ubb_vcore, 38),
	REGULATOR_DATA(ubb_vcore, 39),
