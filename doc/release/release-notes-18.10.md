...
We are pleased to announce the release of TT System Firmware firmware version 18.10.0 🥳🎉.
...
An overview of required and recommended changes to make when migrating from the previous v18.9.0 release can be found in [v18.10 Migration Guide](https://github.com/tenstorrent/tt-system-firmware/tree/main/doc/release/migration-guide-18.10.md).

## Full ChangeLog

The full ChangeLog from the previous v18.9.0 release can be found at the link below.

https://github.com/tenstorrent/tt-system-firmware/compare/v18.9.0...v18.10.0
